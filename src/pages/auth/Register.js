            ...
            <Card>
                ...
                <h2>Register</h2>
                    <form onSubmit={registerUser}>
                       ...
                       />
                        <input type='text' placeholder='Email' required value={email} name="email"
                            onChange={handleInputChange}
                        />
                        <input type='password' placeholder='password' required value={password} name="password"
                            onChange={handleInputChange}
                        />
                        <input type='password' placeholder='Confirm Password' required value={cPassword} name="cPassword"
                            onChange={ handleInputChange}
                        />
